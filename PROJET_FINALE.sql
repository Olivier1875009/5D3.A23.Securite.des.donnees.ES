...
CREATE TABLE utilisateurs (
    ...
    motDePasseBLOWFISH VARCHAR2 (255) DEFAULT 'N/A',
...
INSERT INTO livres(titre, description, cover, paysOrigine, langueOrigine, auteur) VALUES ("Tintin: Vol 714 pour Sydney", "Dans cette nouvelle aventure, nous retrouvons Tintin, Haddock et Tournesol ...", "https://images.renaud-bray.com/images/PG/17/17912-gf.jpg?404=404RB.gif", 1, 1, 4);
INSERT INTO livres(titre, description, cover, paysOrigine, langueOrigine, auteur) VALUES ("Harry Potter à l'école des sorciers", "Le jour de ses onze ans, Harry Potter, ...", "https://images.renaud-bray.com/images/PG/2345/2345638-gf.jpg?404=404RB.gif", 3, 2, 1);
INSERT INTO livres(titre, description, cover, paysOrigine, langueOrigine, auteur) VALUES ("Le seigneur des anneaux : La Fraternité de l'anneau", "Dans les vertes prairies de la Comté, ...", "https://images.renaud-bray.com/images/PG/2595/2595041-gf.jpg?404=404RB.gif", 3, 2, 3);
INSERT INTO livres(titre, description, cover, paysOrigine, langueOrigine, auteur) VALUES ("Les misérables", "Sous la monarchie de Juillet, ...", "https://images.renaud-bray.com/images/PG/1361/1361070-gf.jpg?404=404RB.gif", 1, 1, 2);
